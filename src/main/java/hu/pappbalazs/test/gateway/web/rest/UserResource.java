...
import hu.pappbalazs.test.gateway.service.MailService;
import hu.pappbalazs.test.gateway.service.UserService;
import hu.pappbalazs.test.gateway.service.dto.AdminUserDTO;
import hu.pappbalazs.test.gateway.web.rest.errors.BadRequestAlertException;
import hu.pappbalazs.test.gateway.web.rest.errors.EmailAlreadyUsedException;
import hu.pappbalazs.test.gateway.web.rest.errors.LoginAlreadyUsedException;
import java.net.URI;
 ...
 * <p>
 * This class accesses the {@link hu.pappbalazs.test.gateway.domain.User} entity, and needs to fetch its collection of authorities.
 * <p>
