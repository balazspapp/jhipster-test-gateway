package hu.pappbalazs.test.gateway.web.rest;

import static hu.pappbalazs.test.gateway.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;

import hu.pappbalazs.test.gateway.IntegrationTest;
import hu.pappbalazs.test.gateway.config.Constants;
import hu.pappbalazs.test.gateway.domain.User;
import hu.pappbalazs.test.gateway.repository.AuthorityRepository;
import hu.pappbalazs.test.gateway.repository.UserRepository;
import hu.pappbalazs.test.gateway.security.AuthoritiesConstants;
import hu.pappbalazs.test.gateway.service.UserService;
import hu.pappbalazs.test.gateway.service.dto.AdminUserDTO;
import hu.pappbalazs.test.gateway.service.dto.PasswordChangeDTO;
import hu.pappbalazs.test.gateway.service.dto.UserDTO;
import hu.pappbalazs.test.gateway.web.rest.vm.KeyAndPasswordVM;
import hu.pappbalazs.test.gateway.web.rest.vm.ManagedUserVM;
