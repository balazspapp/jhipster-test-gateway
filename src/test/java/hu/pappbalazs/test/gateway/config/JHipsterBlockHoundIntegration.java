...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("hu.pappbalazs.test.gateway.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("hu.pappbalazs.test.gateway.security.DomainUserDetailsService", "createSpringSecurityUser");
